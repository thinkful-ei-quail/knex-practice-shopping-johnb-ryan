...
describe(`Articles service object`, function () {
  ...
  let testArticles = [
    ...
    },
    {
      ...
      content:
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus consequuntur deserunt commodi, nobis qui inventore corrupti iusto aliquid labore sequi deleniti. Sint, adipisci facere! Velit temporibus debitis rerum.',
    },
    {
      id: 3,
  ...
  context(`Given 'blogful_articles' has data`, () => {
    ...
    it(` getAllArticles() resolves all articles from 'blogful_articles table`, () => {
      // test that the ArticleService.getAllArticles gets data from table
